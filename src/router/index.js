...
const router = new VueRouter({
  ...
  routes: [
    ...
    { path: '/el-mariachi', component: ElMariachi },
    { path: '/companyoung', component: CompanYoung },
    { path: '/dizzyapp', component: Dizzyapp },
    { path: '/bibliovoluntarii-ngo', component: BiblioVoluntarii },
    { path: '/roll-up-poster', component: RollUpPoster },
    { path: '/seiers-bitters', component: SeiersBitters },
    { path: '/cyberboxx', component: Cyberboxx },
    { path: '/pende', component: Pende },
