  ...
  >
    <div class="text-center flex h-16 items-center justify-around">
      <router-link to="/" name="Home">
        ...
        <div class="text-xs">{{ $t("navigation.home") }}</div>
      </router-link>

      <router-link class="" to="/about" name="About">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fas"
        ...
        <div class="text-xs">{{ $t("navigation.about") }}</div>
      </router-link>

      <router-link class="" to="/portfolio" name="Portfolio">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fas"
        ...
        <div class="text-xs">{{ $t("navigation.portfolio") }}</div>
      </router-link>

      <router-link class="" to="/contact" name="Contact">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fas"
        ...
        <div class="text-xs">{{ $t("navigation.contact") }}</div>
      </router-link>

      <div class="font-bold cursor-pointer" v-on:click="switchLocale()">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fas"
          data-icon="globe-europe"
          class="svg-inline--fa fa-globe-europe  w-4 h-4 mx-auto my-1"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 496 512"
        >
        ...
        <div class="text-xs">{{ $t("switchLocale.switch") }}</div>
      </div>
    </div>
  </div>
</template>
