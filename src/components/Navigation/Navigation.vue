  ...
  <div class="nav w-full bg-white fixed z-40 shadow h-16 text-xs">
    <div class="flex max-w-6xl mx-auto md:px-8 xl:px-0">
      <div class="flex w-full h-16">
        ...
        <router-link class="px-6 flex self-center" to="/contact">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
        ...
        <div
          class="font-bold cursor-pointer pl-6 flex self-center link-hover"
        ...
        >
          <svg
            ...
            class="svg-inline--fa fa-globe-europe  w-4 h-4 mr-4"
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 496 512"
          >
